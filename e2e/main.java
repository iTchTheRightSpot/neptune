...
class Main {
    ...
    private static final Function<String, Obj[]> array = (port) -> {
        ...
        return new Obj[] {
                ...
                new Obj("reject order creation. inventory out of stock", post.apply(order, new Order(uuid, 3, OrderStatus.PENDING).json()), 409),
        };
    };
    ...
    public static void main(final String[] args) throws IOException, InterruptedException {
        ...
        for (final Obj obj : array.apply(args != null && args.length > 0 ? args[0] : "8080")) {
            ...
            if (response.statusCode() != obj.status) {
                ...
                String format = String.format("request failed \nerror code: %d,\nrequest body %s", response.statusCode(), response.body());
